      ...
      <div className="max-w-md w-full space-y-8 text-center">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-600">
            There was a problem with your login. This might be because:
          </p>
          <ul className="mt-4 text-sm text-gray-600 text-left space-y-2">
            <li>• Social login providers are not configured</li>
        ...
        <div className="mt-6 text-xs text-gray-500">
          <p>Try using email and password instead, or contact support if the issue persists.</p>
        </div>
      </div>
    </div>
  );
